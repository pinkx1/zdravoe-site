<?php
// Используем отдельный шаблон главной страницы вместо home.php
get_header();
?>
...
<main class="min-h-screen">
			...
			<div class="grid md:grid-cols-2 gap-12 items-center">
				<div class="flex items-center justify-center">
					<div class="max-w-lg w-full">
						<img
							src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/bible.png' ); ?>"
							alt="Открытая Библия"
							class="w-full h-auto"
							loading="lazy"
							decoding="async"
				...
				<div class="space-y-6">
					...
					<p class="text-gray-800 leading-relaxed text-base sm:text-lg">
						Концепция сайта укладывается в один стих из послания Апостола Иоанна: «И вот благовестие, которое мы слышали от Него и возвещаем вам: Бог есть свет, и нет в Нем никакой тьмы». (1Иоанна 1:5).
					</p>
				</div>
			</div>
		</div>
	...
	<section class="container mx-auto px-6 py-20 max-w-7xl">
      ...
      if (!is_wp_error($collections) && !empty($collections)) :
        ...
        <p class="text-gray-600">Пока нет тематических сборников статей.</p>
      <?php endif; ?>
		</div>
	</section>
